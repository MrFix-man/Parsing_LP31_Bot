...
<<<<<<< HEAD:source/alembic/versions/43d0e33c08a4_initial.py
    ...
    sa.Column('car_name', sa.String(length=25), nullable=True),
    ...
    sa.Column('day_of_announcement', sa.String(), nullable=True),
...
>>>>>>> postgresql:source/alembic/versions/078af16349e3_create_initial_base.py
